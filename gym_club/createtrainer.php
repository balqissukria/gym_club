...
$club =  $_POST['club'];
    ...
    do {
        ...
        || empty($membership) || empty($club)){
            $errorMessage = "ALL THE FIELDS ARE REQUIRED";
            break;
        }

        //add new members to database
        $sql= "INSERT INTO trainers(name, email, phone, address, gender, membership, club) " .
        "VALUES ('$name','$email','$phone','$address','$gender' , '$membership','$club')";
    ...
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <div class="offset-sm-3 col-sm-3 d-grid">
                <a class="btn btn-outline-primary" href="/gym_club/usertrainer.php" role="button">Cancel</a>
